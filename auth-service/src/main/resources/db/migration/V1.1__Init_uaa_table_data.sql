...
/*==============================================================*/
insert into uaa_department(id,parent_id,seq,level,full_path,department_code,department_name,description,tenant_id,office_code,created_by,created_at,updated_by,updated_at,deleted,version) values ("f48d26c324c511eab36902420aff0015", "", 1, 1, "900", "900", "总经理", "总经理", "1", "9000", "system", now(), "system", now(), 0, 0);

insert into uaa_department(id,parent_id,seq,level,full_path,department_code,department_name,description,tenant_id,office_code,created_by,created_at,updated_by,updated_at,deleted,version) values ("3bfe40d824c611eab36902420aff0015", "f48d26c324c511eab36902420aff0015", 1, 2, "900|101", "101", "副总经理（行政）", "副总经理（行政）", "1", "9000", "system", now(), "system", now(), 0, 0);
insert into uaa_department(id,parent_id,seq,level,full_path,department_code,department_name,description,tenant_id,office_code,created_by,created_at,updated_by,updated_at,deleted,version) values ("3c15f82024c611eab36902420aff0015", "f48d26c324c511eab36902420aff0015", 1, 2, "900|201", "201", "副总经理（营销）", "副总经理（营销）", "1", "9000", "system", now(), "system", now(), 0, 0);

insert into uaa_department(id,parent_id,seq,level,full_path,department_code,department_name,description,tenant_id,office_code,created_by,created_at,updated_by,updated_at,deleted,version) values (REPLACE(UUID(), "-", ""), "3bfe40d824c611eab36902420aff0015", 1, 3, "900|101", "111", "财务部", "财务部", "1", "9000", "system", now(), "system", now(), 0, 0);
insert into uaa_department(id,parent_id,seq,level,full_path,department_code,department_name,description,tenant_id,office_code,created_by,created_at,updated_by,updated_at,deleted,version) values (REPLACE(UUID(), "-", ""), "3bfe40d824c611eab36902420aff0015", 1, 3, "900|101", "112", "进出口部", "进出口部", "1", "9000", "system", now(), "system", now(), 0, 0);
insert into uaa_department(id,parent_id,seq,level,full_path,department_code,department_name,description,tenant_id,office_code,created_by,created_at,updated_by,updated_at,deleted,version) values (REPLACE(UUID(), "-", ""), "3c15f82024c611eab36902420aff0015", 1, 3, "900|201", "211", "销售部", "销售部", "1", "9000", "system", now(), "system", now(), 0, 0);
insert into uaa_department(id,parent_id,seq,level,full_path,department_code,department_name,description,tenant_id,office_code,created_by,created_at,updated_by,updated_at,deleted,version) values (REPLACE(UUID(), "-", ""), "3c15f82024c611eab36902420aff0015", 1, 3, "900|201", "212", "市场部", "市场部", "1", "9000", "system", now(), "system", now(), 0, 0);
