...
import com.learn.service.proto.grpc.HelloWorldImpl;
...
public class HelloWorldServerTest {
    ...
    public void greeterImpl_replyMessage() throws Exception {
        ...
        grpcCleanup.register(InProcessServerBuilder
                .forName(serverName).directExecutor().addService(new HelloWorldImpl()).build().start());

        HelloWorldGrpc.HelloWorldBlockingStub blockingStub = HelloWorldGrpc.newBlockingStub(
